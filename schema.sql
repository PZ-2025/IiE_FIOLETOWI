...
CREATE TABLE pracownicy (
    ...
    archiwizacja BOOLEAN default 0
 );
...
BEGIN
    ...
    IF NEW.id_produktu != null AND NEW.id_pracownika != null AND NEW.ilosc != null AND NEW.id_kierunku != null AND NEW.id_statusu = 5 AND OLD.id_statusu <> 5 THEN
